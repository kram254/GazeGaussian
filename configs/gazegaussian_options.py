class BaseOptions(object):
    def __init__(self) -> None:
        ...
        self.neural_renderer_type = "dit"
        self.dit_depth = 6
        self.dit_num_heads = 8
        self.dit_patch_size = 8
        self.dit_mlp_ratio = 4.0
        self.dit_predict_noise = False
        self.use_vae = True
        self.vae_z_channels = 4
        ...
        self.orthogonality_loss_importance = 0.01
        
        self.use_intermediate_gaze_training = True
        self.num_intermediate_gazes = 3
        self.intermediate_gaze_freq = 5
