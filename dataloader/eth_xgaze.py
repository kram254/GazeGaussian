        ...
        for num_i in range(0, len(self.selected_keys)):
            ...
            if not os.path.exists(file_path):
                raise FileNotFoundError(
                    ...
                    f"Expected: {self.dataset_name}{self.selected_keys[num_i]}\n"
                    "Please ensure your data is properly downloaded and extracted.\n"
                    "Check your img_dir path in the config."
                )
